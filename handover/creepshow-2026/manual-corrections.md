...
- Confirmed by Logge: the referenced image/sheet is **all Logge / Johannes**. Use these only for Logge (Bote / Diener), not for other cast members.
- Confirmed by Logge: Immich `Caro` is **Carina**.
